...
class MiddlemanCustomKramdown < ::CustomKramdownConverter
...
module Middleman
  module Renderers
    ...
    class CustomKramdownTemplate < ::Tilt::KramdownTemplate
      def evaluate(scope, locals, &block)
        @output ||= begin
          output, warnings = MiddlemanCustomKramdown.convert(@engine.root, @engine.options)
