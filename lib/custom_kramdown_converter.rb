class CustomKramdownConverter < ::Kramdown::Converter::Html
  def convert_codeblock(el, indent)
    ...
    pre_class << " line-numbers" unless lang.blank?

    "#{' '*indent}<pre class=\"#{pre_class}\"><code #{html_attributes(attr)}>#{el.value}#{' '*indent}</code></pre>\n"
  end
